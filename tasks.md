...
| M-6            | SEO content: 16 zone pages + pillar + landing                                                                                         | PR #99             | 16 curated `/zones/:slug` pages, `/zones` pillar, `SEOHead` dynamic meta, landing links, `ZONE_PILLAR_CLICK` event.                                                                  |
