...
> **Last updated:** 2026-06-14 (P1 batch on `fix/room-props-and-drag-freeze`, 5 P1s + 2 P0s resolved; the older post-deploy polish batch is below as a separate "Recently Resolved" block — pending PR)
