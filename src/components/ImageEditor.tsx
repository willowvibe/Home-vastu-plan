          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <textarea
                ...
                className="w-full text-sm p-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none resize-none h-24"
              />
              <button
                onClick={handleEdit}
                disabled={!prompt || isProcessing}
                className="mt-2 w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isProcessing ? (
                  <>
